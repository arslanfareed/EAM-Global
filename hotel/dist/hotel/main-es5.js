(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddTeamComponent = /** @class */ (function () {
                function AddTeamComponent(team) {
                    this.team = team;
                    this.manager = "";
                    this.employeeName = "";
                    this.designation = "";
                ...
                AddTeamComponent.prototype.getAllManagers = function () {
                    var _this = this;
                    this.team.fetchAllManager().subscribe(function (data) {
                        _this.managers = data;
                        console.log(_this.managers);
                    });
                };
                AddTeamComponent.prototype.addTeamMember = function () {
                    if (this.manager == "" || this.employeeName == "" || this.designation == "") {
                        window.alert("Fill all the fields");
                    }
                    else {
                        this.team.addTeamMember(this.manager, this.employeeName, this.designation).subscribe(function (data) {
                            console.log(data);
                        });
                    }
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _services_team_cost_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/team-cost.service */ "./src/app/services/team-cost.service.ts");
            var CalculateCostComponent = /** @class */ (function () {
                function CalculateCostComponent(team) {
                    this.team = team;
                }
                CalculateCostComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.team.fetchEmp("1").subscribe(function (data) {
                        _this.teamMembers = data;
                        console.log(_this.teamMembers);
                    });
                    this.getAllManagers();
                };
                CalculateCostComponent.prototype.getAllManagers = function () {
                    var _this = this;
                    this.team.fetchAllManager().subscribe(function (data) {
                        _this.managers = data;
                        console.log(_this.managers);
                ...
                CalculateCostComponent.prototype.onSelectManager = function (manager) {
                    var _this = this;
                    this.team.fetchEmp(manager).subscribe(function (data) {
                        _this.teamMembers = data;
                        console.log(_this.teamMembers);
                    });
                };
                return CalculateCostComponent;
            }());
            CalculateCostComponent.ctorParameters = function () { return [
                { type: _services_team_cost_service__WEBPACK_IMPORTED_MODULE_2__["TeamCostService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TeamCostService = /** @class */ (function () {
                function TeamCostService(httpClient) {
                    this.httpClient = httpClient;
                    this.baseURL = "http://localhost:80/employee/";
                }
                TeamCostService.prototype.fetchEmp = function (managerId) {
                    return this.httpClient.get('https://eamglobal.000webhostapp.com/employee/fetchTeam.php?managerId=' + managerId);
                };
                TeamCostService.prototype.fetchAllManager = function () {
                    return this.httpClient.get('https://eamglobal.000webhostapp.com/employee/fetchManager.php');
                };
                TeamCostService.prototype.addTeamMember = function (managerId, empName, designationId) {
                ...
                return TeamCostService;
            }());
            TeamCostService.ctorParameters = function () { return [
